...
import { ClipboardCheck, ArrowRight, ShieldAlert, Award } from 'lucide-react';
...
export default function BecomeProviderPage() {
  ...
  const valueProps = [
    { icon: <ClipboardCheck className="w-5 h-5 text-primary" />, title: 'Guaranteed Weekly Settlements', desc: 'All verified services booked and completed are settled to your bank account weekly.' },
    { icon: <Award className="w-5 h-5 text-success" />, title: 'Flexible Work Hours', desc: 'Accept bookings only when you are online. Manage your own schedules.' },
    { icon: <ShieldAlert className="w-5 h-5 text-secondary" />, title: 'Safety & Insurance Support', desc: 'On-job accidental coverage and safety verification protocols for all bookings.' },
  ];
